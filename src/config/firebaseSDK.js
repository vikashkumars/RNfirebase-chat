...
const config = {
	apiKey: 'AIzaSyCYMs8RipKehLHgerLfuIU2nelOcsPdvzQ',
	authDomain: 'simplechat-b27fc.firebaseapp.com/',
	databaseURL: 'https://simplechat-b27fc.firebaseio.com/',
	projectId: 'simplechat-b27fc',
	storageBucket: 'simplechat-b27fc.appspot.com',
	messagingSenderId: '472589886598'
...
class FirebaseSvc {
  ...
  send = messages => {
    for (let i = 0; i < messages.length; i++) {
	  ...
	  console.log("text  "+ text +"-----"+user.email);
      const message = {
        text,
        user,
